...
def simulate(algorithm, T, rescaling_bool, pressure_bool, error_bool, pair_correlation_bool):
    ...
    final_vector_energy = np.array([kin_en(init_vel) + pot_en(rel_dist)])
    ...
    return final_vector_energy, final_vector_kin, final_vector_pot, final_matrix_vel, final_vector_corr, final_matrix_pos, final_rel_dist
